...
function loadConfig({ configPath = CONFIG_PATH } = {}) {
  ...
  return {
    ...
    interactiveMode,
    // Comma-separated allowlist only. An empty value preserves the upstream
    // ephemeral-context behavior for every userId.
    sharedIdentityNames: (process.env.CAMOFOX_SHARED_IDENTITIES || '')
